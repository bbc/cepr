...
class CreateProjectUI extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { workspace:'' , projectName: '', projectTemplateToCopy: '',newProjectCreated : "Success message"};
    ...
    render(){
        ...
        let optionsHtml = templateList.length > 0
    ...
    return (
        <form onSubmit={this.handleSubmit}>
            <div style={{ padding:'20px' , marginRight: '20px' }}>
                ...
                <div style={{ margin : 10 }}>   
                    <label> 
                        Project name <input style={{ marginRight: '150px', float:'right' }} type="text" name="projectName" value={this.state.projectName} size="35" onChange={this.handleInputChange}/>           
                    </label>
                </div>
                <div style={{ margin : 10 }}>
                    <label>
                        Host application    
                        <select style={{ marginRight: '150px', float:'right' }} cols="70" value={this.state.projectTemplateToCopy} name="folderTemplate" onChange={this.handleInputChange} >
                ...
                <div style={{ margin : 10 }}>
                    <label style={{ marginRight : 10 }}> 
                        Project template 
                        <select  name="projectTemplateToCopy" value={this.state.projectTemplate} style={{ marginRight: '150px', float:'right' }} onChange={this.handleInputChange}>
                                {optionsHtml}
                        </select>             
                    </label>
                </div>
