    ...
    search(){
        ...
        var workspacesSearchResult = [];
            ...
            for (var count=0;count<this.wsList.length;count++){
                ...
                if (this.state.productionTeam.length>0 && this.wsList[count].productionTeam == this.state.productionTeam)
                {
                    prodTeamMatch = true;
                }
    ...
    render() {
        ...
        <div style={this.divStyle}>
            <div style={{margin:"10px",marginLeft: "20px",width:'auto'}}>     
                {project.projectName} &nbsp; &nbsp; <a href="#" onClick={this.handleClick.bind(this,project.projectPath)}>Open project</a> &nbsp; <a href="#" onClick={this.handleItemInFolderClick.bind(this,project.projectPath)}>Open Folder</a>
            </div>    
        </div> 
        );
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    <div style={this.divStyle}>
                        ...
                        <div>
                            <table>
                                <tr>
                                    <td><label>Workspace Name</label></td>
                                    <td><input type="text"  value={this.state.workspaceName} onChange={this.handleChange} name="workspaceFilter"/></td>
                                    <td><label>Production Team</label> </td>
                                ...
                                <td>
                                    ...
                                    <td>
                                    <input type="text" value={this.state.projectName} onChange={this.handleInputChange} />
                                    </td>    
                                    <td>
                                        <label>Owner</label>
                                    </td> 
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" value="Search Projects"/></td>
                ...
                <div style={this.divContainer} className="projects-form">
                    ...
                    <div style={this.divStyle}><b> {totalProjects} projects found</b></div> 
                    {listItems}
                </div>
            </div>
        );
