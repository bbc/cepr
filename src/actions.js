...
class Actions extends React.Component  {
  ...
  render() {
    ...
    return (
      <div><div style={{padding: "5px",paddingBottom: "10px"}}> <b>Creative Edit Project Repository</b></div>
        <div className="App" style={{padding: "10px",border: "1px solid"}}>
            <ul style={{display: 'inline'}}>
            <a href="#" onClick={this.handleClick.bind(this,'settings')}>Settings</a>  
            </ul>
            <ul style={{display: 'inline'}}>
            <a href="#" onClick={this.handleClick.bind(this,'workspace')}>Create workspace</a>  
            </ul>
            <ul style={{display: 'inline'}}>
                <a href="#" onClick={this.handleClick.bind(this,'project')}>View Workspaces</a>  
            </ul>
            <ul style={{display: 'inline'}}>
                <a href="#" onClick={this.handleClick.bind(this,'search-project')}>Search projects</a>  
            </ul>
            <ul style={{display: 'inline'}}>
                <a href="#" onClick={this.handleClick.bind(this,'view-project-template')}>Project Templates</a>  
            </ul>
